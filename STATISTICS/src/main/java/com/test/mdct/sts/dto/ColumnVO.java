...
public class ColumnVO {
	...
	public String toString() {
		return "ColumnVO [expt_rt=" + expt_rt + ", column_no_1=" + column_no_1 + ", column_no_2=" + column_no_2
				+ ", column_no_3=" + column_no_3 + ", column_no_4=" + column_no_4 + ", column_no_5=" + column_no_5
				+ ", column_no_6=" + column_no_6 + ", column_no_7=" + column_no_7 + ", column_no_8=" + column_no_8
				+ ", column_no_9=" + column_no_9 + ", column_no_10=" + column_no_10 + ", tot=" + tot + "]";
	}
